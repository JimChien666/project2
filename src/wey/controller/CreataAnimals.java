...
import wey.service.AnimalsService;

@WebServlet("/CreataAnimals")
@MultipartConfig(location = "", fileSizeThreshold = 1024 * 1024, maxFileSize = 1024 * 1024 * 500, maxRequestSize = 1024
* 1024 * 500 * 5)
public class CreataAnimals extends HttpServlet {
...
//		AnimalsService animalsService = (AnimalsService)context.getBean
