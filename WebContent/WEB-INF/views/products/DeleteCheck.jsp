...
<!-- 																							type=PRODUCTS_BLOB -->
			...
			<TD><input class="btn btn-danger" type ="button" onclick="javascript:location.href='/team6/delete/products/${ProductList.id}'" value="確認刪除"></input></TD>
			<TD><input class="btn btn-primary" type ="button" onclick="javascript:location.href='/team6/products'" value="取消"></input></TD>
