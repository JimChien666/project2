...
<div class="col-lg-4">
	<div class="phone">
  		<div class="top" style='background-image: url("${pageContext.servletContext.contextPath}/RetrieveImageServlet?id=${attractionIntroduction.getFirstCoverImgId()}");'></div>
  			
 			 <div class="bottom">
    			<div class="headpic" style='background-image: url("${pageContext.servletContext.contextPath}/RetrieveImageServlet?id=${attractionIntroduction.getFirstContentImgId()}");'>
     			 <div class="name">${attractionIntroduction.getName()}</div>
     			 	...
     			 	${attractionIntroduction.getCity().getName()}${attractionIntroduction.getAddress()}<br/><br/>
